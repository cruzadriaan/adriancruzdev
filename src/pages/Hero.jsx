    ...
    return (
        <div className="flex flex-col sm:w-120 w-85 gap-5 mt-28 mb-5 lg:mx-11 md:mx-8 sm:mx-8 mx-5">
            ...
            <div className="flex flex-row flex-wrap w-100 gap-4 mt-2 text-sm">
                ...
                <a href="/files/CruzAdrianCV.pdf" target="_blank" rel="noopener noreferrer" className="border border-white hover:bg-gray-700 text-white font-semibold lg:py-3 lg:px-5 py-2 px-5 rounded-full cursor-pointer">
