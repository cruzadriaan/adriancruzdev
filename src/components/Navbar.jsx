...
const Navbar = () => {
    return (
        <div className="fixed left-1/2 -translate-x-1/2 w-115 flex flex-row items-center justify-left gap-5 border bg-gray-800 border-gray-600  rounded-2xl px-5 py-6 ">
